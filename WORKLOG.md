...
- [x] Создание задачи как в админке: добавил Prioritet (Låg/Normal/Hög) и Upprepa (6 вариантов) — новый `OptionPickerModal`, оба поля уходят в бэкенд (он их уже поддерживал, мобила просто не слала); даты предзаполнены сегодня 08:00 / 17:00 как в админке; 11 языков
